...
# Define fixtures to provide test data for different scenarios
@pytest.fixture()
# Define a fixture for document with data for patient Marta
def doc_1_marta():
    document_text = '''
Dr John Smith, M.D
...
# Define a fixture for document with data for patient Virat
@pytest.fixture()
def doc_2_virat():
    document_text = '''
Dr John >mith, M.D
...
# Define a fixture for an empty document
@pytest.fixture()
def doc_3_empty():
    return PrescriptionParser('')

# Define test functions to validate different methods of the PrescriptionParser class
def test_get_name(doc_1_marta, doc_2_virat, doc_3_empty):
    # Test the get_field method for patient name extraction
...
def test_get_address(doc_1_marta, doc_2_virat, doc_3_empty):
    # Test the get_field method for patient address extraction
...
def test_get_medicines(doc_1_marta, doc_2_virat, doc_3_empty):
    # Test the get_field method for medicine extraction
...
def test_get_directions(doc_1_marta, doc_2_virat, doc_3_empty):
    # Test the get_field method for directions extraction
...
def test_parse(doc_1_marta, doc_2_virat, doc_3_empty):
    # Test the parse method to extract and parse prescription data
    record_marta = doc_1_marta.parse()  # Parse prescription data for Maria
    # Assert the extracted data for Maria matches the expected values
    ...
    assert record_marta['refills'] == '3'

    record_virat = doc_2_virat.parse()
    # Assert the extracted data for Virat matches the expected values
    assert record_virat == {
