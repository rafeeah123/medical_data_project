...
# Define a subclass of MedicalDocParser for parsing patient details
class PatientDetailsParser(MedicalDocParser):
    def __init__(self, text):
        MedicalDocParser.__init__(self, text)

# Method to parse patient details from the text
    def parse(self):
        return {
...
# Method to remove noise from the extracted patient name
